...
void SceneNode::setTransformationMatrix( glm::mat4 transL )
{
	glm::vec3 myScale;
	glm::quat rotation;
	...
	glm::decompose(transL, myScale, rotation, translation, skew, perspective);
...
void SceneNode::render()
{
	...
	glColor3f(r, g, b);
	tick(); //is this where you implement tick to 
	draw(scale);
